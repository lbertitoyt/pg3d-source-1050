...
internal sealed class RewardedLikeButton : MonoBehaviour
{
	...
	internal void Refresh()
	{
		...
		else if (MainMenuController.sharedController.Map((MainMenuController m) => m.socialGunPanel).Map((UIPanel p) => p.gameObject.activeInHierarchy))
		{
