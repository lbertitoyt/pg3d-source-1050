...
public class URLs
{
	...
	public static string RatingSystemConfigURL
	{
		get
		{
			if (Defs.IsDeveloperBuild)
			{
				return "https://secure.pixelgunserver.com/pixelgun3d-config/ratingSystemConfig/rating_test.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android)
			{
				return (Defs.AndroidEdition != Defs.RuntimeAndroidEdition.Amazon) ? "https://secure.pixelgunserver.com/pixelgun3d-config/ratingSystemConfig/rating_android.json" : "https://secure.pixelgunserver.com/pixelgun3d-config/ratingSystemConfig/rating_amazon.json";
			}
			if (BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64)
			{
				return "https://secure.pixelgunserver.com/pixelgun3d-config/abTestBalansConfig/ratingSystemConfig/rating_wp.json";
			}
			return "https://secure.pixelgunserver.com/pixelgun3d-config/abTestBalansConfig/ratingSystemConfig/rating_ios.json";
		}
	}
