...
public sealed class RewardWindowBase : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		if (animatorLevel != null)
		{
			...
			animatorLevel.SetBool("IsRatingSystem", FriendsController.isUseRatingSystem);
		}
	}
	...
	{
		return Storager.getInt(Defs.IsFacebookLoginRewardaGained, true) == 0 && !CollectOnlyNoShare && ShowLoginsButton && !Device.isPixelGunLow;
	}
	...
	private void SetButtonPositionsAndActive()
	{
		...
		bool flag10 = TwitterController.TwitterSupported && TwitterController.Instance != null && TwitterController.IsLoggedIn;
		bool flag11 = false;
