...
public sealed class VirtualCurrencyHelper
{
	...
	public static int[] coinInappsQuantity
	{
		get
		{
			return (!FriendsController.isShowStaticBank) ? _coinInappsQuantity : _coinInappsQuantityStaticBank;
		}
	}
	...
	public static int[] gemsInappsQuantity
	{
		get
		{
			return (!FriendsController.isShowStaticBank) ? _gemsInappsQuantity : _gemsInappsQuantityStaticBank;
		}
	}
	...
	static VirtualCurrencyHelper()
	{
		...
		AddPrice(StoreKitEventListener.chief, 20);
		AddPrice(StoreKitEventListener.nanosoldier, 20);
		AddPrice(StoreKitEventListener.endmanskin, 20);
		AddPrice(StoreKitEventListener.spaceengineer, 20);
		AddPrice(StoreKitEventListener.steelman, 20);
		AddPrice(StoreKitEventListener.CaptainSkin, 20);
		AddPrice(StoreKitEventListener.HawkSkin, 20);
		AddPrice(StoreKitEventListener.TunderGodSkin, 20);
		AddPrice(StoreKitEventListener.GreenGuySkin, 20);
		AddPrice(StoreKitEventListener.GordonSkin, 20);
		AddPrice(StoreKitEventListener.armor, 10);
		AddPrice(StoreKitEventListener.armor2, 15);
		AddPrice(StoreKitEventListener.armor3, 20);
		AddPrice(StoreKitEventListener.magicGirl, 20);
		AddPrice(StoreKitEventListener.braveGirl, 20);
		AddPrice(StoreKitEventListener.glamDoll, 20);
		AddPrice(StoreKitEventListener.kittyGirl, 20);
		AddPrice(StoreKitEventListener.famosBoy, 20);
		AddPrice(StoreKitEventListener.skin810_1, 20);
		AddPrice(StoreKitEventListener.skin810_2, 20);
		AddPrice(StoreKitEventListener.skin810_3, 20);
		AddPrice(StoreKitEventListener.skin810_4, 20);
		AddPrice(StoreKitEventListener.skin810_5, 20);
		AddPrice(StoreKitEventListener.skin810_6, 20);
		AddPrice(StoreKitEventListener.skin_rapid_girl, 20);
		AddPrice(StoreKitEventListener.skin_silent_killer, 20);
		AddPrice(StoreKitEventListener.skin_daemon_fighter, 20);
		AddPrice(StoreKitEventListener.skin_scary_demon, 20);
		AddPrice(StoreKitEventListener.skin_orc_warrior, 20);
		AddPrice(StoreKitEventListener.skin_kung_fu_master, 20);
		AddPrice(StoreKitEventListener.skin_fire_wizard, 20);
		AddPrice(StoreKitEventListener.skin_ice_wizard, 20);
		AddPrice(StoreKitEventListener.skin_storm_wizard, 20);
		AddPrice(StoreKitEventListener.skin931_1, 20);
		AddPrice(StoreKitEventListener.skin931_2, 20);
		AddPrice(StoreKitEventListener.skin_may1, 20);
		AddPrice(StoreKitEventListener.skin_may2, 20);
		AddPrice(StoreKitEventListener.skin_may3, 20);
		AddPrice(StoreKitEventListener.skin_may4, 20);
		for (int i = 0; i < StoreKitEventListener.Skins_11_040915.Length; i++)
		{
			AddPrice(StoreKitEventListener.Skins_11_040915[i], 20);
		}
		AddPrice("super_socialman", 20);
		AddPrice(StoreKitEventListener.skin_tiger, 20);
		AddPrice(StoreKitEventListener.skin_pitbull, 20);
		AddPrice(StoreKitEventListener.skin_santa, 20);
		AddPrice(StoreKitEventListener.skin_elf_new_year, 20);
		AddPrice(StoreKitEventListener.skin_girl_new_year, 20);
		AddPrice(StoreKitEventListener.skin_cookie_new_year, 20);
		AddPrice(StoreKitEventListener.skin_snowman_new_year, 20);
		AddPrice(StoreKitEventListener.skin_jetti_hnight, 20);
		AddPrice(StoreKitEventListener.skin_startrooper, 20);
		AddPrice(StoreKitEventListener.easter_skin1, 20);
		AddPrice(StoreKitEventListener.easter_skin2, 20);
		...
		for (int j = 0; j < 11; j++)
		{
			AddPrice("newskin_" + j, 20);
		}
		for (int k = 11; k < 19; k++)
		{
			AddPrice("newskin_" + k, 20);
		}
		_prng = null;
	}
