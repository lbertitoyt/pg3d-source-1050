...
public sealed class ClansGUIController : MonoBehaviour, IFriendsGUIController
{
	...
	private readonly System.Lazy<UISprite[]> _newMessagesOverlays;

	private readonly System.Lazy<ClanIncomingInvitesController> _clanIncomingInvitesController;
	...
	{
		_clanIncomingInvitesController = new System.Lazy<ClanIncomingInvitesController>(() => base.gameObject.GetComponent<ClanIncomingInvitesController>());
		_newMessagesOverlays = new System.Lazy<UISprite[]>(delegate
		{
