...
{
	private static readonly System.Lazy<TrafficForwardingInfo> _disabledInstance = new System.Lazy<TrafficForwardingInfo>(() => new TrafficForwardingInfo(null, 0, ExperienceController.maxLevel));
