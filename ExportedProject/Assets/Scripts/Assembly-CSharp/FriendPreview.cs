...
public sealed class FriendPreview : MonoBehaviour
{
	...
	private readonly System.Lazy<ClansGUIController> _clansGuiController;
	...
	{
		_clansGuiController = new System.Lazy<ClansGUIController>(GetComponentInParent<ClansGUIController>);
	}
