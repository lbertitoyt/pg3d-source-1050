...
internal sealed class PlayerArrowToPortalController : MonoBehaviour
{
	...
	private static readonly System.Lazy<UnityEngine.Object> _arrowPrefab = new System.Lazy<UnityEngine.Object>(() => Resources.Load("ArrowToPortal"));

	private Transform _arrowToPortal;

	private readonly System.Lazy<Transform> _arrowToPortalPoint;

	private readonly System.Lazy<Camera> _camera;
	...
	{
		_arrowToPortalPoint = new System.Lazy<Transform>(() => ArrowToPortalPoint.transform);
		_camera = new System.Lazy<Camera>(() => ArrowToPortalPoint.transform.parent.GetComponent<Camera>());
	}
