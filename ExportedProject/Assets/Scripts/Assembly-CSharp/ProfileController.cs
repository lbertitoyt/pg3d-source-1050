...
internal sealed class ProfileController : MonoBehaviour
{
	...
	{
		StatisticHUD componentInChildren = GetComponentInChildren<StatisticHUD>();
	...
	private void Refresh(bool updateWeapon = true)
	{
		if (profileView != null)
		{
			...
			if (FriendsController.sharedController != null)
			{
				...
				if (FriendsController.sharedController.maskName != null && FriendsController.sharedController.maskName != "MaskNoneEquipped")
				{
					profileView.UpdateMask(FriendsController.sharedController.maskName);
				}
				else
				{
