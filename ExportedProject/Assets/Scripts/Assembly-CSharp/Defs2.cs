...
{
	private static Dictionary<string, ItemPrice> _gunPricesFromServer = null;

	private static Dictionary<string, ItemPrice> _armorPricesFromServer = null;
	...
	public static Dictionary<string, ItemPrice> GunPricesFromServer
	{
		get
		{
			return _gunPricesFromServer;
		}
		set
		{
			_gunPricesFromServer = value;
		}
	}

	public static Dictionary<string, ItemPrice> ArmorPricesFromServer
	{
		get
		{
			return _armorPricesFromServer;
		}
		set
		{
			_armorPricesFromServer = value;
		}
	}
