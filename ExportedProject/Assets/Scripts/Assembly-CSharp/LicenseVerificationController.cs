	...
	public LicenseVerificationController()
	{
		...
		_start = delegate
		{
			try
			{
				...
				if (!(licenseVerificationController._licenseVerificationManager == null) && Application.platform == RuntimePlatform.Android && Defs.AndroidEdition == Defs.RuntimeAndroidEdition.GoogleLite)
				{
