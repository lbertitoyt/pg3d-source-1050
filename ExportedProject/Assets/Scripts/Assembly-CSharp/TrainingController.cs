...
public sealed class TrainingController : MonoBehaviour
{
	...
	private readonly System.Lazy<PlayerArrowToPortalController> _directionArrow;
	...
	{
		_directionArrow = new System.Lazy<PlayerArrowToPortalController>(delegate
		{
	...
	public static void OnGetProgress()
	{
		...
		{
			FriendsController.ResetABTestBalans();
		}
