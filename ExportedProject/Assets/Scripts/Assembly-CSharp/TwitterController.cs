...
internal sealed class TwitterController : MonoBehaviour
{
	...
	private static readonly System.Lazy<TwitterFacadeBase> _twitterFacade;
	...
	public static bool TwitterSupported_OldPosts
	{
		get
		{
			return TwitterSupported && BuildSettings.BuildTargetPlatform != RuntimePlatform.MetroPlayerX64 && Instance != null;
		}
	}
	...
	public bool CanPostStatusUpdateWithPriority()
	{
		return false;
	}
