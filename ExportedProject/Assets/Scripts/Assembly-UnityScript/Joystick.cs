...
public class Joystick : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class BlinkReload25 : GenericGenerator<WaitForSeconds>
	{
		internal Joystick self_27;

		public BlinkReload25(Joystick self_)
		{
			self_27 = self_;
		}
		...
		{
			return (IEnumerator<WaitForSeconds>)(object)self_27;
		}
	}
	...
	public IEnumerator BlinkReload()
	{
		return new BlinkReload25(this).GetEnumerator();
	}
