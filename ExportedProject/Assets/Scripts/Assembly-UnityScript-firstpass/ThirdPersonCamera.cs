...
public class ThirdPersonCamera : MonoBehaviour
{
	...
	public void Awake() // should be override
	{
	...
	public void DebugDrawStuff() // should be override
	{
		Debug.DrawLine(_target.position, _target.position + headOffset);
	}

	public float AngleDistance(float a, float b) // should be override
	{
	...
	public void Apply(Transform dummyTarget, Vector3 dummyCenter) // should be override
	{
		if (!controller)
		{
			return;
	...
	public void LateUpdate() // should be override
	{
		Apply(transform, Vector3.zero);
	}

	public void Cut(Transform dummyTarget, Vector3 dummyCenter) // should be override
	{
	...
	public void SetUpRotation(Vector3 centerPos, Vector3 headPos) // should be override
	{
		Vector3 position = cameraTransform.position;
	...
	public Vector3 GetCenterOffset() // should be override
	{
		return centerOffset;
	}
