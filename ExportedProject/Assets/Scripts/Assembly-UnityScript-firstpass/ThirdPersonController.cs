...
public class ThirdPersonController : MonoBehaviour
{
	...
	public void UpdateSmoothedMovementDirection() // should be override
	{
	...
	public void ApplyJumping() // should be override
	{
	...
	public void ApplyGravity() // should be override
	{ 
		if (isControllable)
		{
	...
	public float CalculateJumpVerticalSpeed(float targetJumpHeight) // should be override
	{
		return Mathf.Sqrt(2f * targetJumpHeight * gravity);
	}

	public void DidJump() // should be override
	{
		jumping = true;
	...
	public void Update() // should be override
	{
		if (!isControllable)
		{
	...
	//these should be all overrides lol
}
