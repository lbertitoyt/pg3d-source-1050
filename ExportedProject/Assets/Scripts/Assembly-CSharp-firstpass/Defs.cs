...
public sealed class Defs
{
	...
	public const string RemovedArmorHat_CoinsCountToCompensate = "RemovedArmorHat_CoinsCountToCompensate";
	...
	public const string ratingSystemConfigKey = "ratSysConfigKey";
	...
	public static string GearRemoved_GemsCountToCompensate;
	...
	public static bool isActivABTestStaticBank
	{
		get
		{
			if (!_isInitActivABTestStaticBank)
			{
				_isActivABTestStaticBank = PlayerPrefs.GetInt(nonActivABTestStaticBankKey, 0) == 0;
				_isInitActivABTestStaticBank = true;
			}
			return _isActivABTestStaticBank;
		}
		set
		{
			_isActivABTestStaticBank = value;
			_isInitActivABTestStaticBank = true;
			PlayerPrefs.SetInt(nonActivABTestStaticBankKey, (!value) ? 1 : 0);
		}
	}
	...
	public static bool isJumpAndShootButtonOn
	{
		get
		{
			...
			{
				_isJumpAndShootButtonOn = !Input.touchPressureSupported || PlayerPrefs.GetInt("isJumpAndShootButtonOn", 1) == 1;
	...
	static Defs()
	{
		...
		FirstInAppPurchaseDate_041215 = "test_additional_window_layout_saved_date_221";
		SecondInAppPurchaseDate_041215 = "test_second_additional_window_layout_saved_date_221";
		CoinsForTraining = 15;
		GemsForTraining = 10;
		ExpForTraining = 10;
		GemsGivenRemovedGear = "GemsGivenRemovedGear_10_3_0";
		GearRemoved_GemsCountToCompensate = "GearRemoved_GemsCountToCompensate";
		...
		nonActivABTestStaticBankKey = "nonActivABTestStaticBankKey";
		...
		abTestBalansStartCapitalCoins = 0;
		abTestBalansStartCapitalGems = 0;
